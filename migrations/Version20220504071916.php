 ...
 */
final class Version20220504071916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car ADD brand_id INT NOT NULL, ADD energy_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_773DE69DEDDF52D ON car');
        $this->addSql('ALTER TABLE car DROP brand_id, DROP energy_id');
    }
}
